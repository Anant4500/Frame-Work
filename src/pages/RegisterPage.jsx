      ...
      <div className="min-h-screen flex items-center justify-center relative px-4 py-28">
        ...
        <div className="w-full max-w-md">
          <div className="bg-[#111111] rounded-2xl p-8 sm:p-10 border border-white/5 shadow-[0_8px_40px_rgba(0,0,0,0.5)] text-center">
            ...
            <Link
              to="/login"
              className="inline-block px-6 py-3 bg-purple text-white text-sm font-semibold rounded-xl transition-all duration-300 hover:bg-purple-dark hover:shadow-[0_0_30px_rgba(98,57,191,0.4)]"
            >
              Go to Login
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <button
          ...
          className={`group relative bg-[#111111] rounded-2xl p-8 border text-left transition-all duration-500 hover:scale-[1.03] ${
            hoveredRole === 'user'
              ? 'border-purple/50 shadow-[0_0_40px_rgba(98,57,191,0.15)]'
              : 'border-white/5 hover:border-purple/30'
          }`}
        >
          <div className="w-14 h-14 rounded-xl bg-purple/10 flex items-center justify-center mb-6 transition-all duration-500 group-hover:bg-purple/20 group-hover:shadow-[0_0_20px_rgba(98,57,191,0.2)]">
          ...
          <h3 className="text-xl font-bold mb-2 group-hover:text-purple-light transition-colors">
            User (Collaborator)
          </h3>
      ...
      <div className="bg-[#111111] rounded-2xl p-8 sm:p-10 border border-white/5 shadow-[0_8px_40px_rgba(0,0,0,0.5)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {role === 'creator' && (
            <div>
              ...
              <textarea
                ...
                rows={4}
                maxLength={1500}
                className="w-full px-4 py-3.5 bg-[#1A1A1A] border border-white/10 rounded-xl text-sm text-white placeholder-white/25 outline-none transition-all duration-300 focus:border-purple/60 focus:shadow-[0_0_15px_rgba(98,57,191,0.1)] resize-none"
              />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-purple text-white font-semibold rounded-xl transition-all duration-300 hover:bg-purple-dark hover:shadow-[0_0_30px_rgba(98,57,191,0.4)] hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
          >
            {loading ? (
              <>

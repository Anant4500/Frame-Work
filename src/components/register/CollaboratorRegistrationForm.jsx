...
export default function CollaboratorRegistrationForm({
  ...
  const addSkill = (skill) => {
    setForm((prev) => {
      ...
      if (current.includes(skill) || current.length >= MAX_COLLABORATOR_SKILLS) {
        return prev
      }
  ...
  const toggleSkill = (skill) => {
    if (selectedSkills.includes(skill)) {
      removeSkill(skill)
    } else if (selectedSkills.length < MAX_COLLABORATOR_SKILLS) {
      addSkill(skill)
    }
  }
      ...
      <div className="bg-[#111118] rounded-2xl p-6 sm:p-10 border border-white/[0.08] shadow-[0_20px_50px_rgba(0,0,0,0.6)]">
        ...
        <div className="flex items-center justify-between pb-6 mb-8 border-b border-white/[0.06]">
          ...
          <button
            ...
            onClick={onBack}
            disabled={loading}
            className="text-xs font-semibold text-white/60 hover:text-white flex items-center gap-1.5 py-1 px-2.5 rounded-lg hover:bg-white/[0.04] transition-colors disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6239BF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F]"
          >
        ...
        {error && (
          <div
            id="register-error"
            role="alert"
            className="mb-8 px-4 py-3 bg-red-500/10 border border-red-500/20 rounded-xl text-red-400 text-sm flex items-start gap-2.5"
          >
        ...
        <form onSubmit={onSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/[0.03] border border-white/10 rounded-xl text-sm text-white placeholder:text-white/40 outline-none transition-all focus:border-emerald-500/60 focus:bg-white/[0.05] focus:shadow-[0_0_15px_rgba(16,185,129,0.15)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F]"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  minLength={6}
                  aria-describedby={error ? 'register-error' : undefined}
                  className="w-full px-4 py-3 pr-11 bg-white/[0.03] border border-white/10 rounded-xl text-sm text-white placeholder:text-white/40 outline-none transition-all focus:border-emerald-500/60 focus:bg-white/[0.05] focus:shadow-[0_0_15px_rgba(16,185,129,0.15)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F]"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  aria-label={showPassword ? 'Hide password' : 'Show password'}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-white/50 hover:text-white transition-colors p-1 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F]"
                >
                  {showPassword ? (
          ...
          <div className="space-y-4 pt-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-white/50 tabular-nums">
                {selectedSkills.length} / {MAX_COLLABORATOR_SKILLS} selected
              </span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-white/50">
                Choose the filmmaking skills you specialize in. Select up to {MAX_COLLABORATOR_SKILLS} skills.
              </p>
            </div>
                ...
                {selectedSkills.map((skill) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="text-emerald-400/60 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-400 rounded p-0.5"
                    >
                ...
                <input
                  ...
                  placeholder={
                    selectedSkills.length === 0
                      ...
                      ? 'Search skills...'
                      : `Max ${MAX_COLLABORATOR_SKILLS} skills selected`
                  }
                  disabled={selectedSkills.length >= MAX_COLLABORATOR_SKILLS && !searchQuery}
                  className="flex-1 min-w-[140px] bg-transparent text-xs text-white placeholder:text-white/40 outline-none py-1 px-1.5 disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline-none"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5 pt-1">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-bold tracking-[0.14em] uppercase text-white/50">
                  Departments
                </span>
                {selectedDepartment !== 'All' && (
                  <button
                    ...
                    className="text-[11px] text-emerald-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-400 rounded px-1"
                  >
                    Reset to All
                  </button>
                )}
                ...
                {COLLABORATOR_DEPARTMENTS.map((dept) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg text-xs font-medium border transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F] ${
                        isActive
              ...
              return (
                <div className="space-y-2 pt-1">
                  <div className="flex items-center justify-between">
                    ...
                    {!isSearching && selectedDepartment === 'All' && (
                      <button
                        ...
                        className="text-xs font-semibold text-emerald-400 hover:text-white inline-flex items-center gap-1 py-0.5 px-1.5 rounded transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-400"
                      >
                  ...
                  {displayedSkills.length > 0 ? (
                      ...
                      {displayedSkills.map((skill) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-all duration-200 flex items-center gap-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F] ${
                              isSelected
                    ...
                    <div className="py-2 text-xs text-white/50 flex items-center justify-between">
                      <span>
                        {selectedDepartment !== 'All'
                      ...
                      {selectedDepartment !== 'All' && (
                        <button
                          type="button"
                          onClick={() => setSelectedDepartment('All')}
                          className="text-xs text-emerald-400 hover:text-white underline underline-offset-2 transition-colors ml-2 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-400 rounded"
                        >
                          View all skills
                        </button>
                      )}
                ...
                {EXPERIENCE_LEVELS.map((level) => {
                  ...
                  return (
                    <button
                      ...
                      aria-pressed={isSelected}
                      className={`py-3 px-3 rounded-xl text-xs font-medium border text-center transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F] ${
                        isSelected
              ...
              {AVAILABILITY_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    aria-pressed={isSelected}
                    className={`p-3.5 rounded-xl border text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0F] ${
                      isSelected
                        ? opt.activeBorder
                        : 'bg-white/[0.02] border-white/10 text-white/60 hover:border-white/20 hover:text-white'
                    }`}
          ...
          {/* ── Section 04: Credentials & Profile Setup ── */}
          <div className="space-y-4 pt-2">
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold tracking-[0.16em] uppercase text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded">
                04
              ...
              <h2 className="text-xs font-bold tracking-[0.12em] uppercase text-white/50">
                Credentials &amp; Profile Setup
              </h2>
            </div>

            {/* Profile Photo Setup Helper Card */}
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10 space-y-2">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-emerald-500/10 border border-emerald-500/25 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} aria-hidden="true">
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10 space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/60 leading-relaxed">
                    After verifying your email, you can upload a PDF resume from your Profile.
                  </p>

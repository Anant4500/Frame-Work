  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4">
      ...
      <div className="text-center mb-10 sm:mb-12">
        <h1 className="font-['Fraunces',_serif] text-3xl sm:text-4xl md:text-5xl font-semibold tracking-[-0.02em] leading-[1.15] text-white mb-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
        ...
        <button
          ...
          className={`group relative bg-[#111118] rounded-2xl p-7 sm:p-9 border text-left transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6239BF] flex flex-col justify-between ${
            hoveredRole === 'creator'
        ...
        >
          <div>
            ...
            <h2 className="font-['Fraunces',_serif] text-2xl font-semibold text-white mb-2.5 group-hover:text-purple-light transition-colors">
        ...
        >
          <div>
            ...
            <h2 className="font-['Fraunces',_serif] text-2xl font-semibold text-white mb-2.5 group-hover:text-white transition-colors">
              Join Cast &amp; Crew
            </h2>
            <p className="text-white/50 text-sm leading-relaxed mb-6">
      ...
      <p className="text-center text-white/40 text-sm mt-10">
        ...
        <Link to="/login" className="text-purple-light hover:text-white transition-colors font-semibold underline underline-offset-4">
          Login
        </Link>
      </p>
    </div>
